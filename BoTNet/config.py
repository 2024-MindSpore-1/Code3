...
def create_parser():
    ...
    group.add_argument('--model_url', type=str, default='/cache/data/',
                       help='path to model')
    ...
    group.add_argument('--pretrain_url', type=str, default='/cache/output/',
                       help='model folder to save/load')
    group.add_argument('--grampus_code_file_name', type=str, default='/cache/output/',
                       help='grampus_code_file_name')
    group.add_argument('--grampus_code_url', type=str, default='/cache/output/',
                       help='grampus_code_file_name')

    # replk
    group.add_argument('--layer_decay', type=float, default=1.,
                       help='layer_decay for replknet')
...
def parse_args(args=None):
    ...
    if args_config.config:
        if not os.path.exists(args_config.config):
            args_config.config = os.path.join(os.path.dirname(__file__), args_config.config)
