...
from .pt_maxvit import *
from .pvt import *
from .pvtv2 import *
from .registry import *
from .regnet import *
from .repklnet import *
from .repmlp import *
from .repvgg import *
from .res2net import *
from .resnest import *
...
__all__.extend(pt_maxvit.__all__)
__all__.extend(maxvit.__all__)
...
__all__.extend(repklnet.__all__)
