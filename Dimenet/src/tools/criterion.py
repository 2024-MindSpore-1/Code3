...
class NetWithLoss(nn.Cell):
    ...
    def __init__(self, model):
        ...
        self.model = model
    def construct(self, Z, R, batch_seg, idnb_i, idnb_j, id_expand_kj, id_reduce_ji, id3dnb_i, id3dnb_j, id3dnb_k, targets):

        preds = self.model(Z, R, batch_seg, idnb_i, idnb_j, id_expand_kj, id_reduce_ji, id3dnb_i, id3dnb_j, id3dnb_k)
        preds = preds[0:32]
        loss = ops.ReduceMean()(ops.abs(targets - preds))
