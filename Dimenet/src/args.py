...
def parse_arguments():
    ...
    parser.add_argument("--multi_data_url", default='[]', type=str, help="multi_data_url")
    ...
    parser.add_argument("--lr_gamma", default=0.90, type=float, help="multistep multiplier")
    parser.add_argument("--momentum", default=0.9, type=float, metavar="M", help="momentum")
    parser.add_argument("--num_classes", default=1000, type=int)
    parser.add_argument("--pretrained", dest="pretrained", default=None, type=str, help="use pre-trained model")
    parser.add_argument("--config", type=str, help="Config file to use (see configs dir)", default=None)
...
def get_config():
    ...
    # override args
    print('os.path.abspath(os.curdir)_start')
    print(os.path.abspath(os.curdir))
    print('os.path.abspath(os.curdir)_end')
    print('os.listdir()_start')
    print(os.listdir())
    print('os.listdir()_end')
    print('os.getcwd()_start')
    print(os.getcwd())
    print('os.getcwd()_end')
