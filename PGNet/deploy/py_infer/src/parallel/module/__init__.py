...
from .end2end import E2EInferNode, E2EPostNode, E2EPreNode
...
E2E_DESC = [("E2EPreNode", 1), ("E2EInferNode", 1), ("E2EPostNode", 1)]

MODEL_DICT = {TaskType.DET: DET_DESC, TaskType.REC: REC_DESC, TaskType.CLS: CLS_DESC, TaskType.E2E: E2E_DESC}
