from . import cls_metrics, det_metrics, e2e_metrics, rec_metrics
...
supported_metrics = cls_metrics.__all__ + det_metrics.__all__ + e2e_metrics.__all__ + rec_metrics.__all__
