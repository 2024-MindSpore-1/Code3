...
#    print("device_id = ", device_id)
    ...
    # profiler = Profiler(output_path="./dataTrain")
    # profiler.start()
    ...
    #     # targets = self.concat([self.expand_dims(targets[0][0], -1), self.expand_dims(targets[1][0], -1)])
    #     print("mix sig1 shape = ", item[1].shape)
    #     print("target shape = ", item[3].shape)
    #     print(" ")
    #     cnt = cnt + 1
    #     if cnt > 10:
    #         break
    ...
    print('data process time: %s Seconds' % (process_end - start))
    ...
    save_checkpoint_path = './result/2_false_ckpt_1/'
    ...
    model.train(10, train_dataset, callbacks=callbacks_list, dataset_sink_mode=True)
    # model.train(2, train_dataset, callbacks=callbacks_list, dataset_sink_mode=False)

    train_end = time.time()
    print('data train time: %s Seconds' % (train_end - process_end))
    print('total time: %s Seconds' % (train_end - start))
